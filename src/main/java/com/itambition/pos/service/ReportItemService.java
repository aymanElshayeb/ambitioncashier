...
import com.itambition.pos.entity.exp;
    ...
    public String exportReport(String reportFormat) throws FileNotFoundException, JRException {
        ...
        ArrayList<exp> ee=new ArrayList<exp>();
         ...
         for(int i=0;i<items.size();i++){
            exp a= new exp(items.get(i).getItem_id(),items.get(i).getName(),items.get(i).getBarcode(),items.get(i).getPrice(),items.get(i).getQuantity(),items.get(i).getSubCategory().getName(),items.get(i).getSubCategory().getName());
